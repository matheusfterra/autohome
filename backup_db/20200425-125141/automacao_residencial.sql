...
INSERT INTO `configuracao_user` VALUES (1,0,99,31,1,1,1,19,0,0,34,24,0,5,3,'COM8','2020-04-25 14:51:41',0,'2020-04-24 21:54:22',100,21);
...
CREATE TABLE `medicao` (
  ...
  `potencia` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3908 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tendencias` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5243 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tendencias` VALUES (5237,'Temperatura-Ar-Mais','1900-01-01 09:14:49',2,15),(5239,'Temperatura-Ar-Menos','1900-01-01 20:54:43',4,4),(5240,'Power-Ar-Off','1900-01-01 18:03:17',4,10),(5242,'Power-Ar-On','1900-01-01 18:03:15',4,9),(5238,'Temperatura-Ar-Menos','1900-01-01 16:34:18',0,13),(5236,'Temperatura-Ar-Mais','1900-01-01 16:23:46',0,11);
...
-- Dump completed on 2020-04-25 12:51:45
