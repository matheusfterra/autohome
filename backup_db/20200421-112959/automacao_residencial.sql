...
INSERT INTO `configuracao_user` VALUES (1,0,99,31,1,1,1,24,0,0,22,24,0,5,3,'COM8','2020-04-21 14:29:59',0,'2020-04-17 21:54:22');
...
CREATE TABLE `medicao` (
  ...
  `potencia` double NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1593 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tendencias` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3952 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tendencias` VALUES (3948,'Temperatura-Ar-Mais','1900-01-01 09:14:49',2,15),(3951,'Power-Ar-On','1900-01-01 16:26:44',0,7),(3949,'Temperatura-Ar-Menos','1900-01-01 16:34:18',0,13),(3947,'Temperatura-Ar-Mais','1900-01-01 16:23:46',0,11);
...
-- Dump completed on 2020-04-21 11:30:00
