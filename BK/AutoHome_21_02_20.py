...
class MyWin(QtWidgets.QMainWindow):
    ...
    def machine_learn_acao(self):
        ...
        try:
            ...
            dia_do_grupo[0][0]=dia_comparativo
            ...
            while sair == 0:
                ...
                if nn != 0:
                    ...
                    dia_do_grupo = np.resize(dia_do_grupo, (1, len(dia_do_grupo[0]) + 1))
                    # Atribuo o valor para a posição Criada
                    dia_do_grupo[0][quantidade_grupos_temperatura_ar] = dia_comparativo
                ...
                while data_horario_inicio <= data_comparativa_1 and nn < (n_temperatura_ar - 1) and dia_atual==dia_comparativo:
            ...
            if data_horario_inicio <= data_comparativa_1 and dia_atual==dia_comparativo:
                ...
                dia_do_grupo = np.resize(dia_do_grupo, (1, len(dia_do_grupo[0]) + 1))
                # Atribuo o valor para a posição Criada
                dia_do_grupo[0][quantidade_grupos_temperatura_ar-1] = dia_atual
            ...
            if qtd_somatorio_temperatura_ar>0:
                k=0
                #Criaçcao do Vetor
                tendencia_temperatura_ar = np.zeros((qtd_somatorio_temperatura_ar, 4), dtype='<U19')
                ...
                for nn in range(0, len(eixo_y_temperatura_ar[0])):
                    ...
                    if (eixo_y_temperatura_ar[0][nn] / somatorio_temperatura_ar) >= taxa_tendencia:
                        ...
                        tendencia_temperatura_ar[k][2] = dia_do_grupo[0][nn]
                        tendencia_temperatura_ar[k][3]=eixo_y_temperatura_ar[0][nn]
                        k=k+1
                #Inserção no BD
                try:
                    conexao = pymysql.connect(db='automacao_residencial', user='root', passwd='1')
                    ...
                    for nn in range(0, len(tendencia_temperatura_ar)):
                        # Executa o comando:
                        cursor.execute("INSERT INTO tendencias (acao,horario,dia,valor) VALUES(%s,%s,%s,%s)",(tendencia_temperatura_ar[nn][0], tendencia_temperatura_ar[nn][1], tendencia_temperatura_ar[nn][2], tendencia_temperatura_ar[nn][3]))
                    conexao.close()
