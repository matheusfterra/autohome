...
class MyWin(QtWidgets.QMainWindow):
    ...
    def machine_learning_temperatura_ar_mais(self):
        ...
        try:
            ...
            for x in range(0, len(eixo_x_temperatura_ar_mais[0])):
                #Aqui verifica qual dia da semana é. Tem que fazê-lo variar
                if dia_do_grupo_temperatura_ar_mais[0][x] == 4:
            ...
            #Criação de um vetor Auxiliar, ordenado
            vetor_aux_temperatura_ar_mais=sorted(eixo_x_agrupado_temperatura_ar_mais, key=lambda horario: horario[0])
            # for x in range(0,len(vetor_aux_temperatura_ar_mais)):
            #     print(vetor_aux_temperatura_ar_mais[x][0])
            ...
            for x in range(0,len(vetor_aux_temperatura_ar_mais)):
                if n==0:
                    vetor_x_temperatura_ar_mais[0][0]=vetor_aux_temperatura_ar_mais[0][0]
                    vetor_y_temperatura_ar_mais[0][0]=vetor_aux_temperatura_ar_mais[0][1]
                    vetor_z_temperatura_ar_mais[0][0]=vetor_aux_temperatura_ar_mais[0][2]
                    n=1
                else:
                    ...
                    data_obj2 = datetime.strptime(vetor_aux_temperatura_ar_mais[x][0],'%Y-%m-%d %H:%M:%S')  # Converto em Objeto Data
                    ...
                    #Se o horario atual estiver entre os 15min do horario do grupo, soma o valor de quantidades
                    if data_horario2>data_comparativa_1 and data_horario2<data_comparativa_2:
                        vetor_y_temperatura_ar_mais[0][n-1]=vetor_y_temperatura_ar_mais[0][n-1]+float(vetor_aux_temperatura_ar_mais[x][1])
                    #Se nao, aumento os vetores, e acrescento como um outro grupo
                        ...
                        #Acrescento valores
                        vetor_x_temperatura_ar_mais[0][n] = vetor_aux_temperatura_ar_mais[x][0]
                        vetor_y_temperatura_ar_mais[0][n] = vetor_aux_temperatura_ar_mais[x][1]
                        vetor_z_temperatura_ar_mais[0][n]=vetor_aux_temperatura_ar_mais[x][2]
                        n=n+1
            ...
            ###PAREI AQUI.
            # REPLICAR ESSA CLASSIFICAÇÂO PARA OUTROS DIAS DA SEMANA
            # DEPOIS QUE TODOS OS DIAS DA SEMANA ESTIVEREM NA MATRIZ vetor_x_temperatura_ar_mais, ORGANIZAR A PARTE DEBAIXO DAS TENDENCIAS.

            #Parametros de Configuração para Estatísticas
            somatorio_temperatura_ar_mais=0
            qtd_somatorio_temperatura_ar_mais_4=0
            ...
            for nn in range(0, len(vetor_x_temperatura_ar_mais)):
                if (float(vetor_x_temperatura_ar_mais[nn][1]) / somatorio_temperatura_ar_mais) >= taxa_tendencia:
                    qtd_somatorio_temperatura_ar_mais_4=qtd_somatorio_temperatura_ar_mais_4+1

            #Proteção para nao criar o vetor e nao tentar inserir no BD se nao existir Tendencias.
            if qtd_somatorio_temperatura_ar_mais_4>0:
                k=0
                #Criaçcao do Vetor
                tendencia_temperatura_ar_mais_4 = np.zeros((qtd_somatorio_temperatura_ar_mais_4, 4), dtype='<U19')
                ...
                for nn in range(0, len(vetor_x_temperatura_ar_mais)):
                    ...
                    if (float(vetor_x_temperatura_ar_mais[nn][1]) / somatorio_temperatura_ar_mais) >= taxa_tendencia:
                        ...
                        tendencia_temperatura_ar_mais_4[k][0]="Temperatura-Ar-Mais"
                        tendencia_temperatura_ar_mais_4[k][1]=vetor_x_temperatura_ar_mais[nn][0]
                        tendencia_temperatura_ar_mais_4[k][2]=4
                        tendencia_temperatura_ar_mais_4[k][3]=vetor_x_temperatura_ar_mais[nn][1]
                        k=k+1
                #Inserção no BD
                try:
                    conexao = pymysql.connect(db='automacao_residencial', user='root', passwd='1')
                    ...
                    for nn in range(0, len(tendencia_temperatura_ar_mais_4)):
                        # Executa o comando:
                        cursor.execute("INSERT INTO tendencias (acao,horario,dia,valor) VALUES(%s,%s,%s,%s)",(tendencia_temperatura_ar_mais_4[nn][0], tendencia_temperatura_ar_mais_4[nn][1], tendencia_temperatura_ar_mais_4[nn][2], tendencia_temperatura_ar_mais_4[nn][3]))
                    conexao.close()
    ...
    def machine_learning_temperatura_ar_menos(self):
        ...
        try:
            ...
            resultado = cursor.fetchall()
            if cursor.rowcount > 0:
                mac_acao = np.array([[0] * 3] * cursor.rowcount, dtype='<U25')
                for linha in resultado:
                    mac_acao[qq][0] = linha[0]
                    mac_acao[qq][1] = linha[1]
                    mac_acao[qq][2] = linha[2]
                    ...
                    qq = qq + 1
            #criação do vetorcom a quantidade de resultados
            mac_temperatura_ar_menos = np.array([[0] * 3] * temperatura_ar_menos, dtype='<U25')
            ...
            ##ESTATISTICA TEMPERATURA AR
            for x in range(0,n_temperatura_ar_menos):
                print(mac_temperatura_ar_menos[x][2])

            # Criação dos Eixos E Vetor do dia do grupo
            eixo_x_temperatura_ar_menos = np.zeros((1, 1), dtype='<U25')
            eixo_y_temperatura_ar_menos = np.zeros((1, 1))
            dia_do_grupo_temperatura_ar_menos=np.zeros((1, 1), dtype='<U25')
            ...
            #Loop para saber quantos valores estão acima da Taxa de Tendencia
            for nn in range(0, len(eixo_y_temperatura_ar_menos[0])):
                if (eixo_y_temperatura_ar_menos[0][nn] / somatorio_temperatura_ar_menos) >= taxa_tendencia:
            ...
            if qtd_somatorio_temperatura_ar_menos>0:
                k=0
                #Criaçcao do Vetor
                tendencia_temperatura_ar_menos = np.zeros((qtd_somatorio_temperatura_ar_menos, 4), dtype='<U25')
                #Loop para procurar novamente valores acima da Taxa de Tendencia
                for nn in range(0, len(eixo_y_temperatura_ar_menos[0])):
                    #Condicação que compara cada valor com a Taxa de Tendencia
                    if (eixo_y_temperatura_ar_menos[0][nn] / somatorio_temperatura_ar_menos) >= taxa_tendencia:
                        ...
                        tendencia_temperatura_ar_menos[k][1]=eixo_x_temperatura_ar_menos[0][nn]
                        tendencia_temperatura_ar_menos[k][2] = dia_do_grupo_temperatura_ar_menos[0][nn]
                        tendencia_temperatura_ar_menos[k][3]=eixo_y_temperatura_ar_menos[0][nn]
                        k=k+1
                #Inserção no BD
                try:
                    conexao = pymysql.connect(db='automacao_residencial', user='root', passwd='1')
