        ...
        try:
            ...
            for x in range(0,len(eixo_x_temperatura_ar_mais[0])):
                ...
                if dia_do_grupo_temperatura_ar_mais[0][x]==4:
                    if n==0:
                        vetor_x_temperatura_ar_mais[0][0]=eixo_x_temperatura_ar_mais[0][x]
                        vetor_y_temperatura_ar_mais[0][0]=eixo_y_temperatura_ar_mais[0][x]
                        vetor_z_temperatura_ar_mais[0][0]=dia_do_grupo_temperatura_ar_mais[0][x]
                        n=1
                    else:
                        ...
                        data_obj2 = datetime.strptime(eixo_x_temperatura_ar_mais[0][x],'%Y-%m-%d %H:%M:%S')  # Converto em Objeto Data
                        horario2 = (data_obj2).strftime('%H:%M:%S')  # Faço o Somatorio de TIMES e converto para STRING
                        data_horario2 = datetime.strptime(horario2, '%H:%M:%S')  # Converto novamente para OBJETO

                        if data_horario2>data_comparativa_1 and data_horario2<data_comparativa_2:
                            vetor_y_temperatura_ar_mais[0][n-1]=vetor_y_temperatura_ar_mais[0][n-1]+eixo_y_temperatura_ar_mais[0][x]
                            ...
                            vetor_x_temperatura_ar_mais[0][n] = eixo_x_temperatura_ar_mais[0][x]
                            vetor_y_temperatura_ar_mais[0][n] = eixo_y_temperatura_ar_mais[0][x]
                            vetor_z_temperatura_ar_mais[0][n]=dia_do_grupo_temperatura_ar_mais[0][x]
                            n=n+1
