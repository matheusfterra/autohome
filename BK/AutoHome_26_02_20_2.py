...
class MyWin(QtWidgets.QMainWindow):
    ...
    def machine_learning_temperatura_ar_mais(self):
        ...
        try:
            ...
            for x in range(0,n_temperatura_ar_mais):
            ...
            #################
            meu_vetor=np.zeros((1, 3), dtype='<U19')
            n=0
            for x in range(0, len(eixo_x_temperatura_ar_mais[0])):
                if dia_do_grupo_temperatura_ar_mais[0][x] == 4:
                    if n==0:
                        meu_vetor[n][0]=eixo_x_temperatura_ar_mais[0][x]
                        meu_vetor[n][1]=eixo_y_temperatura_ar_mais[0][x]
                        meu_vetor[n][2]=dia_do_grupo_temperatura_ar_mais[0][x]
                        n=1
                    else:
                        meu_vetor = np.resize(meu_vetor, (len(meu_vetor) + 1, 3))
                        meu_vetor[n][0] = eixo_x_temperatura_ar_mais[0][x]
                        meu_vetor[n][1] = eixo_y_temperatura_ar_mais[0][x]
                        meu_vetor[n][2] = dia_do_grupo_temperatura_ar_mais[0][x]
                        n=n+1

            novo_vetor=sorted(meu_vetor, key=lambda student: student[0])
            # for x in range(0,len(novo_vetor)):
            #     print(novo_vetor[x][0])
            ...
            for x in range(0,len(novo_vetor)):
                if n==0:
                    vetor_x_temperatura_ar_mais[0][0]=novo_vetor[0][0]
                    vetor_y_temperatura_ar_mais[0][0]=novo_vetor[0][1]
                    vetor_z_temperatura_ar_mais[0][0]=novo_vetor[0][2]
                    n=1
                else:
                    ...
                    data_obj2 = datetime.strptime(novo_vetor[x][0],'%Y-%m-%d %H:%M:%S')  # Converto em Objeto Data
                    ...
                    if data_horario2>data_comparativa_1 and data_horario2<data_comparativa_2:
                        vetor_y_temperatura_ar_mais[0][n-1]=vetor_y_temperatura_ar_mais[0][n-1]+float(novo_vetor[x][1])
                        ...
                        vetor_x_temperatura_ar_mais[0][n] = novo_vetor[x][0]
                        vetor_y_temperatura_ar_mais[0][n] = novo_vetor[x][1]
                        vetor_z_temperatura_ar_mais[0][n]=novo_vetor[x][2]
                        n=n+1
