        ...
        try:
            ...
            if cursor.rowcount > 0:
                ...
                for linha in resultado:
                    ...
                    #print(data_obj + timedelta(minutes=15))
            ...
            nn=0
            # for nn in range(0,n_temperatura_ar):
            #     print(mac_temperatura_ar[nn][2])
            # nn = 0
            while sair==0:
                eixo_x[0][quantidade_grupos] = data_comparativa_1

                while data_horario_inicio<=data_comparativa_1 and nn<(n_temperatura_ar-1):
                    eixo_y[0][quantidade_grupos]=eixo_y[0][quantidade_grupos]+1
                    nn = nn + 1
            ...
            if data_horario_inicio<=data_comparativa_1:
                eixo_y[0][quantidade_grupos-1] = eixo_y[0][quantidade_grupos-1] + 1
            else:
                quantidade_grupos = quantidade_grupos + 1
                eixo_x[0][quantidade_grupos-1] = data_horario_inicio
                eixo_y[0][quantidade_grupos-1] = eixo_y[0][quantidade_grupos-1] + 1

            print(eixo_x)
            print(eixo_y)

            #### PRECISO RETIRAR A DATA NO COMPARATIVO, APENAS HORARIO.
