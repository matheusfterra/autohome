...
class MyWin(QtWidgets.QMainWindow):
    ...
    def update_modo_ar(self):
        ...
        if valor=='Normal':
            valor='Turbo'
            self.ui.text_modo_ar.setText(valor)
        elif valor=='Turbo':
            valor='Normal'
            self.ui.text_modo_ar.setText(valor)
        teste_conexao = 0
    ...
    def set_configs_user(self):
        try:
            ...
            # Executa o comando:
            cursor.execute("SELECT intensidade_iluminacao, temperatura, aprendizagem, economia, controle,temp_banho,temp_ar,modo_ar,volume_tv,canais_tv FROM configuracao_user  WHERE id=1")
            ...
            if cursor.rowcount > 0:
                for linha in resultado:
                    ...
                    valor_temp_banho=linha[5]
                    valor_temp_ar = linha[6]
                    valor_modo_ar = linha[7]
                    valor_volume_tv = linha[8]
                    valor_canais_tv = linha[9]
                ...
                self.ui.text_modo_ar.setText(valor_modo_ar)
